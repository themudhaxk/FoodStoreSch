...
const CategoryList = () => {
  ...
  const [updatingImages, setUpdatingImages] = useState(categories?.images || []); // Ensure this is used for image upload logic
  ...
  const handleUpdateCategory = async (e) => {
    ...
    try {
      ...
      // Update the category
      const {result} = await updateCategory({ categoryId: selectedCategory._id, updatedCategory }).unwrap();
    ...
    <div className="ml-[10rem] flex flex-col md:flex-row">
      ...
      <div className="md:w-3/4 p-3">
        <div className="h-12 text-black">
          ...
          <Model className="text-center" isOpen={modelVisible} onClose={() => setModelVisible(false)}>
            <div className="mt-[3rem]">
